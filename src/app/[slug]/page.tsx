      ...
      <article>
        <header className="mb-8">
          <div>
            <div>
              ...
              {post.subtitle && (
                <div className="mt-3 flex items-center gap-2 text-sm">
                  <span className="rounded-full border border-[var(--border)] bg-[var(--border)] px-2 py-0.5 font-semibold uppercase tracking-wide text-[var(--foreground)]">
                    Series
                  </span>
            ...
            {post.github && (
              <a
                ...
                className="mt-4 inline-flex items-center gap-2 rounded-lg border border-[var(--border)] bg-[var(--surface)] px-4 py-2 text-sm font-medium text-[var(--foreground)] transition hover:border-[var(--muted)] hover:bg-[var(--border)]"
              >
          ...
          {post.date ? (
            ...
            <span className="mt-3 inline-flex items-center gap-2 rounded-full border border-[var(--border)] bg-[var(--border)] px-2.5 py-1 text-sm font-medium text-[var(--muted)]">
              <span className="h-2 w-2 rounded-full bg-[#67e8f9]" aria-hidden />
              Coming soon
            </span>
          )}
